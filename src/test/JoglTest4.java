...
import test.framework.Semantic;

/**
 * Created by GBarbieri on 16.03.2017.
 */
public class JoglTest4 implements GLEventListener, KeyListener {
    ...
    private void initDebug(GL4 gl) {
        ...
        // gl.glDebugMessageControl(GL_DONT_CARE, GL_DONT_CARE, GL_DONT_CARE, 0, null,
        // false);

        // gl.glDebugMessageControl(GL_DONT_CARE, GL_DONT_CARE, GL_DEBUG_SEVERITY_HIGH,
        // 0, null, true);

        // gl.glDebugMessageControl(GL_DONT_CARE, GL_DONT_CARE,
        // GL_DEBUG_SEVERITY_MEDIUM, 0, null, true);
    }
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        // model matrix
        {
            ...
            // float[] rotateZ = FloatUtil.makeRotationAxis(new float[16], 0, diff, 0f, 0f,
            // 1f, new float[3]);
    ...
    public void reshape(GLAutoDrawable drawable, int x, int y, int width, int height) {
        ...
        // ortho matrix
        // float[] ortho = FloatUtil.makeOrtho(new float[16], 0, false, -1f, 1f, -1f,
        // 1f, 1f, -1f);
