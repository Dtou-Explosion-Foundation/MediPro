...
public class HelloTriangle implements GLEventListener, KeyListener {
    ...
    private void initBuffers(GL4 gl) {
        ...
        globalMatricesPointer = gl.glMapNamedBufferRange(bufferName.get(Buffer.GLOBAL_MATRICES), 0, Mat4x4.SIZE * 2,
                GL_MAP_WRITE_BIT | GL_MAP_PERSISTENT_BIT | GL_MAP_COHERENT_BIT | GL_MAP_INVALIDATE_BUFFER_BIT); // flags

        modelMatrixPointer = gl.glMapNamedBufferRange(bufferName.get(Buffer.MODEL_MATRIX), 0, Mat4x4.SIZE,
    ...
    private void initVertexArray(GL4 gl) {
        ...
        gl.glVertexArrayAttribFormat(vertexArrayName.get(0), Semantic.Attr.COLOR, Vec3.length, GL_FLOAT, false,
                Vec2.SIZE);
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        // model matrix
        {
            ...
            model.scale_(0.5f).rotate_(diff, 0f, 0f, 1f).to(modelMatrixPointer);
        }
